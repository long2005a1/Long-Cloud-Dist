import{aE as l,ct as h,cu as e,cv as o,cw as n,cx as p,cy as m,cz as f,cA as t,cB as d,cC as F,cD as v,cE as E,cF as u,cG as M,cH as H}from"./index.fd0fe7bf.js";import{j as B,l as I,m as V,n as A}from"./index.6e835ddc.js";import{j as x}from"./index.cd7d39dd.js";import{I as k}from"./Layout.b94cc2df.js";import{a as D}from"./index.60e3ac51.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function G(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:k,db:B,md:v,epub:I,iso:V,m3u8:t,"doc,docx":E,"xls,xlsx":u,"ppt,pptx":M,pdf:H,psd:L,ai:Z,url:A,cast:D},w=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(i.toLowerCase()))return r;if(e().includes(i))return o}switch(a){case c.FOLDER:return x;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return m;case c.IMAGE:return p;default:return n}},O=a=>w(a.type,h(a.name));export{G as A,c as O,O as g};
