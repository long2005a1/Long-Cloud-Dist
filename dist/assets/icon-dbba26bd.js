import{aQ as l,cK as h,cq as o,cL as e,cM as n,cN as p,cO as m,cP as f,cQ as t,cR as d,cS as F,cT as v,cU as M,cV as u,cW as E,cX as H}from"./index-ff851c3c.js";import{i as B,m as I,n as V,o as A}from"./index-dd9c6a04.js";import{j as k}from"./index-8c39f611.js";import{I as x}from"./Layout-82475201.js";import{a as L}from"./index-110fcbff.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function D(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function O(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:x,db:B,md:v,epub:I,iso:V,m3u8:t,"doc,docx":M,"xls,xlsx":u,"ppt,pptx":E,pdf:H,psd:D,ai:Z,url:A,cast:L},N=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(o(i))return e}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return m;case c.IMAGE:return p;default:return n}},R=a=>N(a.type,a.name);export{O as A,c as O,R as g};
