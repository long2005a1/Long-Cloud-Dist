import{aG as l,cw as h,co as o,cx as e,cy as n,cz as p,cA as m,cB as f,cC as t,cD as d,cE as F,cF as v,cG as E,cH as u,cI as M,cJ as H}from"./index.3896f625.js";import{j as B,l as I,m as V,n as A}from"./index.83c23ce4.js";import{j as k}from"./index.f611ef70.js";import{I as x}from"./Layout.94d8733e.js";import{a as D}from"./index.43081e59.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function U(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:x,db:B,md:v,epub:I,iso:V,m3u8:t,"doc,docx":E,"xls,xlsx":u,"ppt,pptx":M,pdf:H,psd:L,ai:Z,url:A,cast:D},w=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(o(i))return e}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return m;case c.IMAGE:return p;default:return n}},O=a=>w(a.type,a.name);export{U as A,c as O,O as g};
